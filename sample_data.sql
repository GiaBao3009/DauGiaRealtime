-- ===================================
-- DỮ LIỆU MẪU CHO HỆ THỐNG ĐẤU GIÁ
-- ===================================
...
DELETE FROM Users WHERE user_id > 0; -- Xóa tất cả users
...
-- 2. Insert Users
-- Mật khẩu đều là: admin123 (đã hash SHA-256)
...
'https://images.unsplash.com/photo-1696446702008-22cc0d09d1df?w=800', 1, 6, 25000000, 25000000),
...
-- 8. Insert Newsletter subscribers
...
-- 9. Insert AuctionParticipants (người tham gia đấu giá)
...
-- User1: user1 / admin123
-- User2: user2 / admin123
-- User3: user3 / admin123
-- User4: user4 / admin123
-- Seller1: seller1 / admin123
-- ===================================

PRINT 'Import dữ liệu mẫu thành công!';
PRINT 'Tổng số:';
PRINT '- Users: 6 tài khoản';
PRINT '- Categories: 10 danh mục';
PRINT '- Products: 20 sản phẩm';
PRINT '- Auctions: 15 phiên (6 đang diễn ra, 3 sắp diễn ra, 5 đã kết thúc, 1 đã hủy)';
PRINT '- Bids: 30 lượt đấu giá';
PRINT '- Notifications: 7 thông báo';
PRINT '- Newsletter: 5 subscribers';
PRINT '';
PRINT 'Đăng nhập với: admin / admin123 hoặc user1 / admin123';
GO
